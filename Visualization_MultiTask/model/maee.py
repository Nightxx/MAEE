    ...
    def call(self, inputs, **kwargs):
        ...
        for i in range(self.num_fields):
            ...
            for j in range(self.field_expert_num_list[i]):
                ...
                all_experts.append(expert_output)
        ...
        all_experts.append(common_expert_output)
        ...
        all_experts_concat = tf.stack(all_experts, axis=2)
        outputs = [final_outputs, all_experts_concat]
        return outputs
